/* Grss.vapi generated by vapigen, do not modify. */
...
namespace Grss {
	...
	public class FeedChannel : GLib.Object {
		...
		[CCode (has_construct_function = false)]
		public FeedChannel.from_xml (Xml.Doc* doc) throws GLib.Error;
	...
	public class FeedParser : GLib.Object {
		[CCode (has_construct_function = false)]
		public FeedParser ();
		public GLib.List<Grss.FeedItem> parse (Grss.FeedChannel feed, Xml.Doc* doc) throws GLib.Error;
		public void parse_channel (Grss.FeedChannel feed, Xml.Doc* doc) throws GLib.Error;
	}
